          ...
          <Container class="h-full">
            <div class="w-full h-full flex flex-col px-[1em]">
              <div class="w-full flex flex-row justify-between relative pb-[1em]">
                ...
                <button class="px-2 py-2 cursor-pointer" @click="isOpen = false">close</button>
              ...
              <div class="flex flex-col h-full justify-between pt-[2em]">
                ...
                <div class="flex flex-col w-full">
                  <div class="grid w-full grid-cols-6 w-full pt-[2em] pb-[2em] gap-gutte relative">
                    ...
                    <div class="rounded-round bg-amber-50 w-2 h-2 col-start-1"></div>
                    ...
                    <div class="col-start-5 col-span-2 flex flex-col gap-1">
                      <span>Accolades</span>
                      <ul class="mt-2 flex flex-col text-small">
                        <li>Awwwards</li>
                        <li>CSSDA</li>
                  ...
                  <div class="grid w-full grid-cols-6 w-full pt-[2em] pb-[2em] gap-gutte relative">
                    ...
                    <div class="col-start-3 flex flex-col gap-1">
                      <span>Social</span>
                      <ul class="mt-2 flex flex-col text-small">
                        <li v-for="social in settings?.socials" :key="social.url">
                    ...
                    <div class="col-start-5 col-span-2">
                      <div class="flex flex-col gap-1 items-start">
                        ...
                        <TextLink class="text-small" href="https://cal.com/bamoj/discovery-session">
                          Booking
                        </TextLink>
                      </div>
                      <div class="flex flex-col gap-1 mt-5 items-start">
                        <span>Project Inquiries</span>
                        <TextLink class="text-small" href="mailto:hi@bamoj.com">
                          hi@bamoj.com
                        </TextLink>
                      </div>
                    </div>
                  </div>
                  <div class="flex w-full flex-row justify-between relative pt-[2em] pb-[1em]">
                    <div class="absolute top-0 w-full h-[1px]">
                      <div class="w-full h-full bg-white opacity-50"></div>
                    </div>
