...
<template>
  <nav
    class="mix-blend-exclusion fixed top-0 left-0 z-1000 flex w-full"
  >
    <Container>
      <div
        class="grid grid-cols-12 py-4 gap-gutter items-start w-full"
      >
        <div
          class="col-start-1 col-end-3 flex flex-col max-md:col-end-5"
        >
          <div class="overflow-hidden">
            <h1 data-load-top class="text-main">Studio•Bämo.J®</h1>
          </div>
          <div class="overflow-hidden">
            <span
              data-load-top
              class="inline-block text-small font-normal"
            >
              *Semi Temporary Site
            </span>
          </div>
        ...
        <div class="col-start-5 flex flex-col max-md:hidden">
          <div class="overflow-hidden">
            <span data-load-top class="inline-block">{{ time }}</span>
          </div>
          <div class="overflow-hidden">
            <span
              data-load-top
        ...
        <div
          class="col-start-8 col-span-2 flex flex-col max-md:hidden"
        >
          <div class="overflow-hidden">
            <span data-load-top class="inline-block">
              Available for project
            </span>
          </div>
          <div class="overflow-hidden">
            <span data-load-top class="inline-block text-small">
              Sept / 2026
            </span>
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            <div
              class="menu_btn_dot_wrap flex flex-row gap-1 items-start"
            >
              <div data-load-top-cicle class="menu_btn_cirlce"></div>
              <div data-load-top-cicle class="menu_btn_cirlce"></div>
              <div data-load-top-cicle class="menu_btn_cirlce"></div>
            </div>
          </button>
