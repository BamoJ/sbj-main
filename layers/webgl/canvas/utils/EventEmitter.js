// Namespaced event emitter — ported 1:1 from the lab (sbj-lab
// src/canvas/utils/EventEmitter.js). Page and Time extend this so their
// `.on(...)` / `.trigger(...)` API reads exactly like the lab.
