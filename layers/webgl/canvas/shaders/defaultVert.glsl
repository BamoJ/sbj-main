// DOMPlane shared vertex shader (ported from sbj-starter-main). Perlin noise is
// inlined below because `?raw` imports don't process `#include`.
uniform float uTime;
...
// ── Classic Perlin 3D Noise (Stefan Gustavson) — inlined from includes/perlinNoise.glsl
